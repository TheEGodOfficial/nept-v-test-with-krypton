...
local MainWeldS = KadeAPI:SetHatAlign(weaponinfo, rarmor, CFrame.new(0,0,0)*CFrame.Angles(math.rad(90),math.rad(90),math.rad(90))) --CreateWeld(Part475,rarmor,Part475,0,0,0,math.rad(90),math.rad(90),math.rad(0),0,0,0,math.rad(0),math.rad(0),math.rad(0))
